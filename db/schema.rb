...
ActiveRecord::Schema.define(version: 20170604041502) do
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.index ["retailer_id"], name: "index_items_on_retailer_id", using: :btree
  end
  ...
  create_table "retailers", force: :cascade do |t|
    ...
    t.index ["item_id"], name: "index_retailers_on_item_id", using: :btree
  ...
  add_foreign_key "retailers", "items"
